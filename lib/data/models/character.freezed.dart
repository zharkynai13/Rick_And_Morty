...
class _$_Results implements _Results {
  ...
  @override
  String toString() {
    return 'Results(id: $id, name: $name, status: $status, species: $species, type: $type, gender: $gender, image: $image, episode: $episode, created: $created)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, status, species, type,
      gender, image, const DeepCollectionEquality().hash(_episode), created);
